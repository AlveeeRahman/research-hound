# Brainstorming (Stage 2 — generate and triage ideas)
...
`references/brainstorming/sources.md`.
...
See `references/brainstorming/facilitation_workflows.md`.
...
vetoes inside an averaged score. See `references/brainstorming/idea_evaluation.md`.
...
- **AI hallucination or homogenization:** human-first ideation, provenance,
  ...
  suspiciously repeated frames. See `references/brainstorming/responsible_ai.md`.
...
```bash
python scripts/brainstorming/session_scaffold.py --help
python scripts/brainstorming/validate_register.py --help
python scripts/brainstorming/evaluate_matrix.py --help
```

Create a session register:

```bash
python scripts/brainstorming/session_scaffold.py \
...
```bash
python scripts/brainstorming/validate_register.py session.json --output validation.json
```
...
```bash
python scripts/brainstorming/evaluate_matrix.py scores.csv \
...
`references/brainstorming/idea_evaluation.md`.

## Reference index

- `references/brainstorming/brainstorming_methods.md` — evidence-calibrated method selection,
  nominal groups, Delphi, structured elicitation, and creative prompts.
- `references/brainstorming/facilitation_workflows.md` — ready-to-run individual, group, and
  asynchronous session protocols plus provenance templates.
- `references/brainstorming/idea_evaluation.md` — criteria, scoring formula, uncertainty,
  sensitivity analysis, gates, and decision logs.
- `references/brainstorming/responsible_ai.md` — accountable AI assistance, confidentiality,
  hallucination, homogenization, disclosure, dual-use, and integrity.
- `references/brainstorming/sources.md` — dated primary studies and official guidance
