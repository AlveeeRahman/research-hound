# Writing (Stage 4 — build the manuscript)
...
not sufficient. See `references/writing/authorship_ai_confidentiality.md`.
...
discovery but do not verify a claim. See `references/writing/evidence_workflow.md`.
...
```bash
python3 scripts/writing/scaffold_manuscript.py \
...
```bash
python3 scripts/writing/select_reporting_guidelines.py select \
  --study-design randomized_trial
```
...
acceptance. See `references/writing/reporting_guidelines.md`.
...
`references/writing/imrad_structure.md` and `references/writing/writing_principles.md`.
...
```bash
python3 scripts/writing/check_consistency.py consistency_manifest.json
```
...
```bash
python3 scripts/writing/validate_manifest.py source_manifest.json \
  --kind source --require-verified
python3 scripts/writing/audit_claims.py manuscript.md claims.csv source_manifest.json
python3 scripts/writing/check_references.py source_manifest.json
```
...
```bash
python3 scripts/writing/validate_authorship.py authorship.json
```

Do not generate a disclosure from assumptions. See
`references/writing/authorship_ai_confidentiality.md`.
...
conditions. See `references/writing/research_integrity_open_science.md`.
...
See `references/writing/figures_tables.md`.
...
```bash
python3 scripts/writing/select_reporting_guidelines.py check reporting_coverage.json
```
...
```bash
python3 scripts/writing/validate_manifest.py manuscript_manifest.json --kind manuscript
python3 scripts/writing/lint_manuscript.py manuscript.md \
...
- `assets/writing/REPORT_FORMATTING_GUIDE.md`
- `references/writing/professional_report_formatting.md`
- `references/writing/journal_policies.md`
...
- `assets/writing/manuscript_scaffold.md`
- `assets/writing/manuscript_manifest_template.json`
- `assets/writing/source_manifest_template.json`
- `assets/writing/claim_evidence_template.csv`
- `assets/writing/consistency_manifest_template.json`
- `assets/writing/authorship_template.json`
- `assets/writing/reporting_coverage_template.json`
- `assets/writing/reporting_guidelines.json`

### Scripts

- `scripts/writing/scaffold_manuscript.py`
- `scripts/writing/validate_manifest.py`
- `scripts/writing/select_reporting_guidelines.py`
- `scripts/writing/audit_claims.py`
- `scripts/writing/check_consistency.py`
- `scripts/writing/check_references.py`
- `scripts/writing/validate_authorship.py`
- `scripts/writing/lint_manuscript.py`

All scripts are local, deterministic, bounded, dependency-free, and network-free. See
`references/writing/cli_reference.md`.

### References

- `references/writing/evidence_workflow.md`
- `references/writing/writing_principles.md`
- `references/writing/imrad_structure.md`
- `references/writing/citation_styles.md`
- `references/writing/reporting_guidelines.md`
- `references/writing/figures_tables.md`
- `references/writing/authorship_ai_confidentiality.md`
- `references/writing/research_integrity_open_science.md`
- `references/writing/journal_policies.md`
- `references/writing/professional_report_formatting.md`
- `references/writing/cli_reference.md`
- `references/writing/source_ledger.md`
