# Literature review (Stage 2 — find out what is already known)
...
A systematic review usually needs a PRISMA flow diagram, and most reviews are clearer
with a search-strategy flowchart or a thematic synthesis diagram. Write them as Mermaid
inline — Claude Code and claude.ai both render a ` ```mermaid ` block — and keep the
source next to the manuscript so the counts in the figure and the counts in the text can
be diffed against each other.

Nothing in this skill generates images, and nothing sends a figure description to a
hosted model. `references/writing/figures_tables.md` carries the publication standards.
...
in [references/literature-review/core_workflow.md](references/literature-review/core_workflow.md):
...
[references/literature-review/search_and_citation.md](references/literature-review/search_and_citation.md), and a full worked
review is in [references/literature-review/example_workflow.md](references/literature-review/example_workflow.md).
...
**Scripts:**
- `scripts/literature-review/verify_citations.py`: Verify DOIs and generate formatted citations
- `scripts/literature-review/generate_pdf.py`: Convert markdown to professional PDF
- `scripts/literature-review/search_databases.py`: Process, deduplicate, and format search results

**References:**
- `references/literature-review/citation_styles.md`: Detailed citation formatting guide (APA, Nature, Vancouver, Chicago, IEEE)
- `references/literature-review/database_strategies.md`: Comprehensive database search strategies

**Assets:**
- `assets/literature-review/review_template.md`: Complete literature review template with all sections
...
Check dependencies:
```bash
python scripts/literature-review/generate_pdf.py --check-deps
```
