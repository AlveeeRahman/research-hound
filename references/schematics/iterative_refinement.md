...
python scripts/schematics/generate_schematic.py "diagram" -o out.png --doc-type journal      # 8.5/10
python scripts/schematics/generate_schematic.py "diagram" -o out.png --doc-type conference   # 8.0/10
python scripts/schematics/generate_schematic.py "diagram" -o out.png --doc-type poster       # 7.0/10
python scripts/schematics/generate_schematic.py "diagram" -o out.png --doc-type presentation # 6.5/10
...
python scripts/schematics/generate_schematic.py "flowchart" -o flow.png -v

# Provide API key via flag
python scripts/schematics/generate_schematic.py "diagram" -o out.png --api-key "sk-or-v1-..."

# Combine options
python scripts/schematics/generate_schematic.py "neural network" -o nn.png --doc-type journal --iterations 2 -v
```
