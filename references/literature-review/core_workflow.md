...
1. **Create Review Document** from template:
   ```bash
   cp assets/literature-review/review_template.md my_literature_review.md
   ```
...
1. **Verify All DOIs**:
   ```bash
   python scripts/literature-review/verify_citations.py my_literature_review.md
   ```
...
3. **Format Citations Consistently**:
   - Choose one citation style and use throughout (see `references/literature-review/citation_styles.md`)
...
1. **Generate PDF**:
   ```bash
   python scripts/literature-review/generate_pdf.py my_literature_review.md \
     --citation-style apa \
