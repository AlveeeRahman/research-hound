...
**Reference:** See `references/critical-thinking/scientific_method.md` for detailed principles and `references/critical-thinking/experimental_design.md` for comprehensive design checklist.
...
**Reference:** See `references/critical-thinking/common_biases.md` for comprehensive bias taxonomy with detection and mitigation strategies.
...
**Reference:** See `references/critical-thinking/statistical_pitfalls.md` for detailed pitfalls and correct practices.
...
**Reference:** See `references/critical-thinking/evidence_hierarchy.md` for detailed hierarchy, GRADE system, and quality assessment tools.
...
**Reference:** See `references/critical-thinking/logical_fallacies.md` for comprehensive fallacy catalog with examples and detection strategies.
...
**Reference:** See `references/critical-thinking/experimental_design.md` for comprehensive design checklist covering all stages from question to dissemination.
