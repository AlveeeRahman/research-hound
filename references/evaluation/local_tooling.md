...
- `assets/evaluation/rubric_template.json` — valid structure, but deliberately records
  content validity as not established.
- `assets/evaluation/evaluation_template.json` — structurally valid all-missing example.
- `assets/evaluation/evidence_manifest_template.json` — synthetic local-reference records.
- `assets/evaluation/process_checklist_template.json` — fail-closed unconfirmed controls.
- `assets/evaluation/ratings_template.csv` — pseudonymous synthetic agreement data.
