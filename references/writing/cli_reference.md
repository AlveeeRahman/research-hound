...
python3 scripts/writing/validate_manifest.py source_manifest.json --kind source
python3 scripts/writing/validate_manifest.py source_manifest.json --kind source --require-verified
```
...
```bash
python3 scripts/writing/select_reporting_guidelines.py select --study-design systematic_review
