...
```bash
python3 scripts/writing/select_reporting_guidelines.py select --study-design randomized_trial
python3 scripts/writing/select_reporting_guidelines.py select --study-design randomized_trial --protocol
python3 scripts/writing/select_reporting_guidelines.py select --study-design diagnostic_accuracy --ai
python3 scripts/writing/select_reporting_guidelines.py select --study-design prediction_model --ai --llm
```
